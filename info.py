...
BOT_TOKEN = environ.get('BOT_TOKEN', "5478011283:AAHZEiH1c2tWzNy26VWmz5H2gtFLnQFWr2I")
...
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1001712123362').split()]
...
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/+A0JfvhDGZJlkNDll')
CHNL_LNK = environ.get('CHNL_LNK', 'https://t.me/cynitebackup')
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'https://t.me/+A0JfvhDGZJlkNDll')
...
FILE_CHANNEL_LINK = environ.get('FILE_CHANNEL_LINK', 't.me/The_Hackerz_Zone')
HOW_DWLD_LINK = environ.get('HOW_DWLD_LINK', 'https://t.me/cynitemovies/3')

# Log Channels
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', -1001712123362))
RQST_LOG_CHANNEL = int(environ.get('RQST_LOG_CHANNEL', -1001712123362))
...
URL_SHORTNER_WEBSITE_API = environ.get('URL_SHORTNER_WEBSITE_API', '813a8f143fa948cc4c187a94421e0b75b86eeb32')
